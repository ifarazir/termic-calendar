...
export function AddCourseDrawer({ children }) {
        ...
        return (
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle className="font-bold mb-3">افزودن درس</DialogTitle>
                    </DialogHeader>
                    <ProfileForm />
                </DialogContent>
            </Dialog>
    ...
    return (
        <Drawer open={open} onOpenChange={setOpen}>
            ...
            <DrawerContent>
                <DrawerHeader className="text-start mb-3">
                    <DrawerTitle>افزودن درس</DrawerTitle>
                </DrawerHeader>
...
const FormSchema = z.object({
    course_name: z.string({
        required_error: "لطفا نام درس را وارد کنید.",
    }),
    course_teacher: z.string({
        required_error: "لطفا نام مدرس را وارد کنید.",
    }).optional(),
    color: z.enum(Object.keys(colors), {
        required_error: "لطفا یک رنگ انتخاب کنید.",
    }),
    days: z.number({
        required_error: "لطفا روزهای برگزاری را انتخاب کنید.",
    }),
    start_time: z.string({
    ...
    class_room: z.string({
        required_error: "لطفا محل برگزاری را وارد کنید.",
    }),
})
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className={cn("grid items-start gap-4", className)}>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="ریاضی ۱" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                {/* Begin: Course Teacher */}
                <FormField
                    control={form.control}
                    name="course_teacher"
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>نام مدرس</FormLabel>
                            <FormControl>
                                <Input placeholder="دکتر دهقان" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                {/* Begin: Course Class Room */}
                <FormField
                    control={form.control}
                    name="class_room"
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>محل برگزاری</FormLabel>
                            <FormControl>
                                <Input placeholder="۲۰۱" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                {/* End: Course Class Room */}
                                ...
                                >
                                    {
                                        Object.keys(colors).map((color) => {
                                            return (
                                                <FormItem key={color} className="flex items-center justify-start">
                                                    <FormControl>
                ...
                <div className="grid gap-2">
                    <Label htmlFor="course_periods">روزهای برگزاری</Label>

                    <div className="grid w-full grid-cols-4 gap-1 h-20 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground">
                ...
                {/* End: Course Start Time */}

                {/* Begin: Course End Time */}
                <FormField
                    control={form.control}
                    name="end_time"
                    render={({ field }) => (
